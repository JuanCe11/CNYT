...
public class NumerosComplejosTest {
	...
	public void deberiaSumar() {
		...
		assertEquals(respuesta,new Complejo(1,1));
	}
	...
	public void deberiaMultiplicar() {
		...
		assertEquals(respuesta,new Complejo(34,12));
	}
	...
	public void deberiaMultiplicar1() {
		...
		int[] c2 = {1,-2};		
		Complejo respuesta = Calculadora.multiplicacion(c1, c2);
		assertEquals(respuesta,new Complejo(-5,5));
	}
	...
	public void deberiaDividir() {
		...
		assertEquals(respuesta,new Complejo(0,1));
	}
	...
	public void deberiaDividir1() {
		...
		assertEquals(respuesta,new Complejo((double)-3/2,(double)-3/2));
	}
	...
	public void deberiaDividir2() {
		...
		assertEquals(respuesta,new Complejo((double)23/41,(double)-2/41));
	}
	...
	public void deberiaDividir3() {
		...
		assertEquals(respuesta,new Complejo((double)-1/5,(double)-7/5));
	}
	...
	public void deberiaDividir4() {
		...
		try {
			...
			assertEquals(e.getMessage(),CalculadoraException.DIVISION_CERO);
		}
	}
	...
	public void deberiaConjugado() {
		...
		assertEquals(respuesta,new Complejo(0,(double)-2.0));
	}
	...
	public void deberiaConjugado1() {
		int[] c1 = {20,-65};
		Complejo respuesta = Calculadora.conjugado(c1);
		assertEquals(respuesta,new Complejo(20,(double)65));
	}
